...
<Navbar
	let:hidden
	let:toggle
	class="fixed top-0 z-50 bg-gradient-to-b from-primary-800 to-secondary-900"
>
	<NavBrand href="/">
		<img src={logo} alt="FlowClock logo" class="w-28 md:w-32 lg:w-40" />
	</NavBrand>
	<NavHamburger on:click={toggle} menuClass="text-primary-50 w-full" />
	<NavUl
		{hidden}
