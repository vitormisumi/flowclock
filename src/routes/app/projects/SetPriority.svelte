...
<Dropdown class="rounded-md py-2 bg-secondary-200 dark:bg-secondary-700" placement="top">
	{#each priorityOptions as option}
		<DropdownItem
			class="hover:bg-secondary-100 hover:dark:bg-secondary-800 {priorityColor(
				option.value,
				'text'
